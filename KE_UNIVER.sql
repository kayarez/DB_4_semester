...
on primary
( name = N'KE_UNIVER_mdf', filename = N'D:\4 СЕМЕСТР\БД\4LAB\KE_UNIVER_mdf.mdf', 
   size = 5120Kb, maxsize = 10240Kb, filegrowth = 1024Kb),
( name = N'KE_UNIVER_ndf', filename = N'D:\4 СЕМЕСТР\БД\4LAB\KE_UNIVER_ndf.ndf', 
   size = 5120Kb, maxsize = 10240Kb, filegrowth = 10%),
filegroup G1
( name = N'KE_UNIVER11_ndf', filename = N'D:\4 СЕМЕСТР\БД\4LAB\KE_UNIVER11.ndf', 
   size = 10240Kb, maxsize = 15360Kb, filegrowth = 1024Kb),
( name = N'KE_UNIVER12_ndf', filename = N'D:\4 СЕМЕСТР\БД\4LAB\KE_UNIVER12.ndf', 
   size = 2048Kb, maxsize = 5120Kb, filegrowth = 1024Kb),
filegroup G2
( name = N'KE_UNIVER21_ndf', filename = N'D:\4 СЕМЕСТР\БД\4LAB\KE_UNIVER21.ndf', 
   size = 5120Kb, maxsize = 10240Kb, filegrowth = 1024Kb),
( name = N'KE_UNIVER22_ndf', filename = N'D:\4 СЕМЕСТР\БД\4LAB\KE_UNIVER22.ndf', 
   size = 2048Kb, maxsize = 5120Kb, filegrowth = 1024Kb)
log on
( name = N'KE_UNIVER_log', filename=N'D:\4 СЕМЕСТР\БД\4LAB\KE_UNIVER_log.ldf',       
...
(   AUDITORIUM   varchar(20)  constraint AUDITORIUM_PK  primary key,              
    AUDITORIUM_TYPES     char(10) constraint  AUDITORIUM_AUDITORIUM_TYPE_FK foreign key         
...
insert into  AUDITORIUM   (AUDITORIUM, AUDITORIUM_NAME,  
 AUDITORIUM_TYPES, AUDITORIUM_CAPACITY)   
...
create table PROGRESS
 (  SUBJECT   varchar(10) constraint PROGRESS_SUBJECT_FK foreign key
